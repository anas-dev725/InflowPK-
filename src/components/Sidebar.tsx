...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  const navSections: {
    ...
    {
      stageNumber: "Stage 1",
      stageTitle: "Deal & Contract Review",
      items: [
        {
          id: "aideal",
          stepNumber: "AI Judge",
          title: "AI Deal Router",
          subtitle: "Chat & brief to best route",
          icon: Bot,
          badge: "AI",
        },
        {
          ...
          subtitle: "Detect scope creep & traps",
          icon: FileSearch,
          badge: "Guard",
        },
      ],
    ...
    {
      stageNumber: "Stage 2",
      stageTitle: "Payment Routing & Rates",
      items: [
        {
          id: "optimizer",
          stepNumber: "Compare",
          title: "Payout Calculator",
          subtitle: "Find highest take-home PKR",
          icon: Wallet,
          badge: "Max PKR",
        },
        {
          ...
          subtitle: "Match client payment method",
          icon: Compass,
          badge: "Speed",
        },
        {
    ...
    {
      stageNumber: "Stage 3",
      stageTitle: "Bank Clearance & Tax",
      items: [
        {
          id: "compliance",
          stepNumber: "0.25% Tax",
          title: "SBP & e-PRC Pack",
          subtitle: "Bank letter & tax lock memo",
          icon: ShieldCheck,
          badge: "Sec 154A",
        },
        {
          id: "ledger",
          stepNumber: "Ledger",
          title: "Inflow & FX Ledger",
          subtitle: "Realized earnings & FX saved",
          icon: TrendingUp,
          badge: "Audit",
        },
        {
          ...
          subtitle: "All 11 options, cards & KYC",
      ...
      <div className="flex-1 overflow-y-auto px-4 py-5 space-y-4">
        ...
        {onOpenGuideModal && (
          <button
            ...
            className="w-full py-2 px-3 rounded-xl bg-emerald-50 dark:bg-emerald-950/40 hover:bg-emerald-100/80 dark:hover:bg-emerald-900/60 border border-emerald-200 dark:border-emerald-800/60 text-emerald-900 dark:text-emerald-300 text-xs font-bold transition-all flex items-center justify-between group"
          >
            <div className="flex items-center gap-2">
              <BookOpen className="w-4 h-4 text-emerald-700 dark:text-emerald-400" />
              <span>How InflowPK Works</span>
            </div>
        ...
        {/* Navigation Sections following Freelancer Lifecycle Story */}
        <div className="space-y-4" id="features-nav-panel">
          {navSections.map((section, sIdx) => (
            <div key={sIdx} className="space-y-1">
              <div className="px-2 pt-1 flex items-center justify-between">
                <span className="text-[10px] font-extrabold uppercase tracking-wider text-slate-400 dark:text-slate-500">
                  {section.stageNumber}: {section.stageTitle}
                </span>
              </div>
