...
// Input: Messy real-world input (chat screenshot, WhatsApp thread, Upwork brief, email, or invoice image)
// Model does the work: Classifies, Extracts, Reasons, Routes
// Output: Structured optimal gateway, delivery speed, bonus rates, client-ready message & compliance pack
app.post("/api/route-deal", async (req, res) => {
